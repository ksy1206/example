...
<script type="text/javascript" src="../js/update_party.js"></script>
    ...
    <div class="form-group">
     <h2>상단 입력란</h2>
      <label for="title">제목:</label>
       <input type="hidden" id="party_no" value="${list[0].party_no}">
      <input type="text" class="form-control" id="title" placeholder="제목" value="${list[0].title}">
    </div>
    
   <h2>순서</h2>
     <div class="form-group">
       <label for="sort_no">순서:</label>
 	  <input type="text" class="form-control" id="sort_no" placeholder="순서" value="${list[0].sort_no}">
    </div>
    
     <h2>리스트 메인이미지 입력(1장)</h2>
 	 <form id="file_upload_9" name="file_upload_09" method="post"  enctype="multipart/form-data" action="<%=cp%>/comm/saveFileUpload.do">
  ...
  <table class="table table-bordered">
   ...
   <h2>정보</h2>
    ...
    <div class="form-group">
 	  ...
 	  <input type="text" class="form-control" id="info_8" placeholder="정보 8" value="${list[0].info_8}">
    </div>
    
    <div class="form-group">
       <label for="info_9">정보 입력란9:</label>
 	  <input type="text" class="form-control" id="info_9" placeholder="정보 9" value="${list[0].info_9}">
    </div>
    
    <div class="form-group">
       <label for="info_10">정보 입력란10:</label>
 	  <input type="text" class="form-control" id="info_10" placeholder="정보 10" value="${list[0].info_10}">
    </div>
