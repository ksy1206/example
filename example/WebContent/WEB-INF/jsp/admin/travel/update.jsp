...
<script type="text/javascript" src="../js/update_travel.js"></script>
  ...
  <h2>여행지정보 수정</h2>
    <div class="form-group">
     <h2>상단 입력란</h2>
      ...
      <input type="hidden" id="travel_no" value="${list[0].travel_no}">
 ...
 <div id="add_img_div" style="display: none;">
   ...
   <h2>상단이미지 아래 입력란</h2>
    <div class="form-group">
 	  ...
 	  <input type="text" class="form-control" id="sub_title" placeholder="부제목" value="${list[0].sub_title}"> 
    </div>
     <h2>이용시간</h2>
     <div class="form-group">
    ...
    <div class="form-group">
 	  ...
 	  <input type="text" class="form-control" id="info_1" placeholder="정보 1" value="${list[0].info_1}">
    </div>
     <div class="form-group">
       <label for="info_2">정보 입력란2:</label>
 	  <input type="text" class="form-control" id="info_2" placeholder="정보 2" value="${list[0].info_2}">
    </div>
     <div class="form-group">
       <label for="info_3">정보 입력란3:</label>
 	  <input type="text" class="form-control" id="info_3" placeholder="정보 3" value="${list[0].info_3}">
    </div>
     <div class="form-group">
       <label for="info_4">정보 입력란4:</label>
 	  <input type="text" class="form-control" id="info_4" placeholder="정보 4" value="${list[0].info_4}">
    </div>
     <div class="form-group">
       <label for="info_5">정보 입력란5:</label>
 	  <input type="text" class="form-control" id="info_5" placeholder="정보 5" value="${list[0].info_5}">
    </div>
     <div class="form-group">
       <label for="info_6">정보 입력란6:</label>
 	  <input type="text" class="form-control" id="info_6" placeholder="정보 6" value="${list[0].info_6}">
    </div>
     <div class="form-group">
       <label for="info_7">정보 입력란7:</label>
 	  <input type="text" class="form-control" id="info_7" placeholder="정보 7" value="${list[0].info_7}">
    </div>
 ...
 <h2>이용료</h2>
  <table class="table table-bordered">
    <tbody>
      <tr>
        <td>    </td>
        <td><input type="text" id="pay_nm_1"  value="${list[0].pay_nm_1}"></td>
        <td><input type="text" id="pay_nm_2"  value="${list[0].pay_nm_2}"></td>
        <td><input type="text" id="pay_nm_3"  value="${list[0].pay_nm_3}"></td>
        <td><input type="text" id="pay_nm_4"  value="${list[0].pay_nm_4}"></td>
      </tr>
      <tr>
        <td><input type="text" id="pay_kind_1"  value="${list[0].pay_kind_1}"></td>
        <td><input type="text" id="pay_1_1"  value="${list[0].pay_1_1}"></td>
        <td><input type="text" id="pay_2_1"  value="${list[0].pay_2_1}"></td>
        <td><input type="text" id="pay_3_1"  value="${list[0].pay_3_1}"></td>
        <td><input type="text" id="pay_4_1"  value="${list[0].pay_4_1}"></td>
      </tr>
       <tr>
        <td><input type="text" id="pay_kind_2" value="${list[0].pay_kind_2}"></td>
        <td><input type="text" id="pay_1_2" value="${list[0].pay_1_2}"></td>
        <td><input type="text" id="pay_2_2" value="${list[0].pay_2_2}"></td>
        <td><input type="text" id="pay_3_2" value="${list[0].pay_3_2}"></td>
        <td><input type="text" id="pay_4_2" value="${list[0].pay_4_2}"></td>
      </tr>
       <tr>
        <td><input type="text" id="pay_kind_3" value="${list[0].pay_kind_3}" ></td>
        <td><input type="text" id="pay_1_3" value="${list[0].pay_1_3}"></td>
        <td><input type="text" id="pay_2_3" value="${list[0].pay_2_3}"></td>
        <td><input type="text" id="pay_3_3" value="${list[0].pay_3_3}" ></td>
        <td><input type="text" id="pay_4_3" value="${list[0].pay_4_3}"></td>
      </tr>
    </tbody>
  </table>
    ...
    <div class="form-group">
 	  ...
 	  <input type="text" class="form-control" id="add_info_1" placeholder="추가정보 1" value="${list[0].add_info_1}" >
    </div>
     <div class="form-group">
       <label for="add_info_2">추가정보 입력란2:</label>
 	  <input type="text" class="form-control" id="add_info_2" placeholder="추가정보 2" value="${list[0].add_info_2}">
    </div>
     <div class="form-group">
       <label for="add_info_3">추가정보 입력란3:</label>
 	  <input type="text" class="form-control" id="add_info_3" placeholder="추가정보 3" value="${list[0].add_info_3}">
    </div>
     <div class="form-group">
       <label for="add_info_4">추가정보 입력란4:</label>
 	  <input type="text" class="form-control" id="add_info_4" placeholder="추가정보 4" value="${list[0].add_info_4}">
    </div>
     <div class="form-group">
       <label for="add_info_5">추가정보 입력란5:</label>
 	  <input type="text" class="form-control" id="add_info_5" placeholder="추가정보 5" value="${list[0].add_info_5}">
    </div>
     <div class="form-group">
       <label for="add_info_6">추가정보 입력란6:</label>
 	  <input type="text" class="form-control" id="add_info_6" placeholder="추가정보 6" value="${list[0].add_info_6}">
    </div>
     <div class="form-group">
       <label for="add_info_7">추가정보 입력란7:</label>
 	  <input type="text" class="form-control" id="add_info_7" placeholder="추가정보 7" value="${list[0].add_info_7}">
    </div>
...
<!--     시설 -->
	...
	<div align="center" style="z-index: 2;">
		<div class="row">
		<c:if test="${list[0].fac_1_yn == 'Y'}">	
		  <div class="col-sm-3" id="fac_1_yn_div"><input type="hidden" id="fac_1_yn" value="Y"><img src="../img/travel/fac_1_y.png" width="30%"></div>
		</c:if>
		<c:if test="${list[0].fac_1_yn == 'N'}">	
		  <div class="col-sm-3" id="fac_1_yn_div"><input type="hidden" id="fac_1_yn" value="N"><img src="../img/travel/fac_1_n.png" width="30%"></div>
		</c:if>
		<c:if test="${list[0].fac_2_yn == 'Y'}">	
		  <div class="col-sm-3" id="fac_2_yn_div"><input type="hidden" id="fac_2_yn" value="Y"><img src="../img/travel/fac_2_y.png" width="30%"></div>
		</c:if>
		<c:if test="${list[0].fac_2_yn == 'N'}">	
		  <div class="col-sm-3" id="fac_2_yn_div"><input type="hidden" id="fac_2_yn" value="N"><img src="../img/travel/fac_2_n.png" width="30%"></div>
		</c:if>    
		<c:if test="${list[0].fac_3_yn == 'Y'}">	
		  <div class="col-sm-3" id="fac_3_yn_div"><input type="hidden" id="fac_3_yn" value="Y"><img src="../img/travel/fac_3_y.png" width="30%"></div>
		</c:if>
		<c:if test="${list[0].fac_3_yn == 'N'}">	
		  <div class="col-sm-3" id="fac_3_yn_div"><input type="hidden" id="fac_3_yn" value="N"><img src="../img/travel/fac_3_n.png" width="30%"></div>
		</c:if>    
		<c:if test="${list[0].fac_4_yn == 'Y'}">	
		  <div class="col-sm-3" id="fac_4_yn_div"><input type="hidden" id="fac_4_yn" value="Y"><img src="../img/travel/fac_4_y.png" width="30%"></div>
		</c:if>
		<c:if test="${list[0].fac_4_yn == 'N'}">	
		  <div class="col-sm-3" id="fac_4_yn_div"><input type="hidden" id="fac_4_yn" value="N"><img src="../img/travel/fac_4_n.png" width="30%"></div>
		</c:if>        
		  
		</div>
		<br><br><br>
		<div class="row">
		<c:if test="${list[0].fac_5_yn == 'Y'}">	
		  <div class="col-sm-3" id="fac_5_yn_div"><input type="hidden" id="fac_5_yn" value="Y"><img src="../img/travel/fac_5_y.png" width="30%"></div>
		</c:if>
		<c:if test="${list[0].fac_5_yn == 'N'}">	
		  <div class="col-sm-3" id="fac_5_yn_div"><input type="hidden" id="fac_5_yn" value="N"><img src="../img/travel/fac_5_n.png" width="30%"></div>
		</c:if>
		<c:if test="${list[0].fac_6_yn == 'Y'}">	
		  <div class="col-sm-3" id="fac_6_yn_div"><input type="hidden" id="fac_6_yn" value="Y"><img src="../img/travel/fac_6_y.png" width="30%"></div>
		</c:if>
		<c:if test="${list[0].fac_6_yn == 'N'}">	
		  <div class="col-sm-3" id="fac_6_yn_div"><input type="hidden" id="fac_6_yn" value="N"><img src="../img/travel/fac_6_n.png" width="30%"></div>
		</c:if>    
		<c:if test="${list[0].fac_7_yn == 'Y'}">	
		  <div class="col-sm-3" id="fac_7_yn_div"><input type="hidden" id="fac_7_yn" value="Y"><img src="../img/travel/fac_7_y.png" width="30%"></div>
		</c:if>
		<c:if test="${list[0].fac_7_yn == 'N'}">	
		  <div class="col-sm-3" id="fac_7_yn_div"><input type="hidden" id="fac_7_yn" value="N"><img src="../img/travel/fac_7_n.png" width="30%"></div>
		</c:if>    
		<c:if test="${list[0].fac_8_yn == 'Y'}">	
		  <div class="col-sm-3" id="fac_8_yn_div"><input type="hidden" id="fac_8_yn" value="Y"><img src="../img/travel/fac_8_y.png" width="30%"></div>
		</c:if>
		<c:if test="${list[0].fac_8_yn == 'N'}">	
		  <div class="col-sm-3" id="fac_8_yn_div"><input type="hidden" id="fac_8_yn" value="N"><img src="../img/travel/fac_8_n.png" width="30%"></div>
		</c:if>  
		</div>
	</div>	
...
<jsp:include page="../include/address.jsp"/>
	...
	<h2>해쉬태그</h2>
	  <div class="form-group">
 	  ...
 	  <input type="text" class="form-control" id="hashtag" placeholder="ex)가,나,다" value="${list[0].hashtag}">
    </div>
	<h2>먹거리 활성화 </h2>
	<div class="radio">
	<c:if test="${list[0].fd_yn == 'Y'}">	
		 <label><input type="radio" name="fd_yn" id="fd_yn" value="Y" checked="checked" >활성화</label>
	  <label><input type="radio" name="fd_yn" id="fd_yn" value="N" >비활성화</label>
	</c:if>
	<c:if test="${list[0].fd_yn == 'N'}">	
	...
	<c:if test="${list[0].fd_yn == 'N'}">	
      ...
      <label for="fd_nm_1">음식 이름1:</label>
 	  ...
 	  <input type="text" class="form-control" id="fd_nm_1" placeholder="음식1" value="${list[0].fd_nm_1}">
    </div>
    <div class="form-group">
      <label for="fd_nm_2">음식 이름2:</label>
 	  <input type="hidden" id="fd_no_2" value="2">
 	  <input type="text" class="form-control" id="fd_nm_2" placeholder="음식2" value="${list[0].fd_nm_2}">
    </div>
    <div class="form-group">
      <label for="fd_nm_3">음식 이름3:</label>
 	  <input type="hidden" id="fd_no_3" value="3">
 	  <input type="text" class="form-control" id="fd_nm_3" placeholder="음식3" value="${list[0].fd_nm_3}">
    </div>
    <div class="form-group">
      <label for="fd_nm_4">음식 이름4:</label>
 	  <input type="hidden" id="fd_no_4" value="4">
 	  <input type="text" class="form-control" id="fd_nm_4" placeholder="음식4" value="${list[0].fd_nm_4}">
    </div>
    <div class="form-group">
      <label for="fd_nm_5">음식 이름5:</label>
 	  <input type="hidden" id="fd_no_5" value="5">
 	  <input type="text" class="form-control" id="fd_nm_5" placeholder="음식5" value="${list[0].fd_nm_5}">
    </div>
    <div class="form-group">
      <label for="fd_nm_6">음식 이름6:</label>
 	  <input type="hidden" id="fd_no_6" value="6">
 	  <input type="text" class="form-control" id="fd_nm_6" placeholder="음식6" value="${list[0].fd_nm_6}">
    </div>
    <div class="form-group">
      <label for="fd_nm_7">음식 이름7:</label>
 	  <input type="hidden" id="fd_no_7" value="7">
 	  <input type="text" class="form-control" id="fd_nm_7" placeholder="음식7" value="${list[0].fd_nm_7}">
    </div>
    <div class="form-group">
      <label for="fd_nm_8">음식 이름8:</label>
 	  <input type="hidden" id="fd_no_8" value="8">
 	  <input type="text" class="form-control" id="fd_nm_8" placeholder="음식8" value="${list[0].fd_nm_8}">
    </div>
    <div class="form-group">
      <label for="fd_nm_9">음식 이름9:</label>
 	  <input type="hidden" id="fd_no_9" value="9">
 	  <input type="text" class="form-control" id="fd_nm_9" placeholder="음식9" value="${list[0].fd_nm_9}">
    </div>
    <div class="form-group">
      <label for="fd_nm_10">음식 이름10:</label>
 	  <input type="hidden" id="fd_no_10" value="10">
 	  <input type="text" class="form-control" id="fd_nm_10" placeholder="음식10" value="${list[0].fd_nm_10}">
    </div>
    </div>
    
  <div style="text-align: center;">
  	<button type="button" class="btn btn-primary btn-lg"  onclick="chk_save();">수정</button>
  </div>
