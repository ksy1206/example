...
<div data-role="page">
	<div class="main_header" data-role="header" data-position="fixed">
		...
		<span style="margin-top:0.3em; font-size: 22px; color: #6d6558; position: absolute;">${title}</span>
	...
	<div>
		<c:forEach var="list" items="${list}">
			<div style="margin-top: 1.5em; margin-left: 1em; margin-right: 1em;">
				<img src="/upload/img/TRAVEL/${list.main_img_nm}" width="100%;" height="270px" onclick="move_travel_details('${list.travel_no}')">
			</div>
		</c:forEach>
	</div>
</div>
