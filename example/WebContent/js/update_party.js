	...
	function save_party(){
		...
		params += "&use_time_2="+use_time_2+"&use_time_3="+use_time_3+"&party_no="+party_no;
		params += "&pay_nm_1="+pay_nm_1+"&pay_nm_2="+pay_nm_2+"&pay_nm_3="+pay_nm_3+"&sort_no="+sort_no;
